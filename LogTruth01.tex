...
His concept of analyticity remained the same in essence, but the presentation was re-organised to give a single definition of analyticity as a property of sentences in a language with a given semantics, rather than a general prescription of how language specific definitions of analyticity might be presented.

As to Logical Truth, Quine's critique was more incisive, since in his account of this idea in \emph{Meaning and Necessity}\cite{carnap47} Carnap had stayed too close to the narrow conception of logical truth found in Wittgenstein's \emph{Tractatus Logico-Philosophicus1921}\cite{wittgenstein1921}.
